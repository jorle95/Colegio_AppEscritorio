...
public class ModProf extends javax.swing.JFrame {
    ...
    public ModProf(Profesor p) {
        initComponents();
        this.profe=p;
        initCampos(profe);
    }
    
        private void initCampos(Profesor profe) {
        this.jLabel1.setText("Modificar profesor id: "+profe.getId());
        
        this.jTextField1.setText(""+profe.getId());
        jTextField1.setEditable(false);
        this.jTextField2.setText(profe.getNombre());
        this.jTextField3.setText(profe.getCorreo());
        this.jTextField4.setText(""+profe.getEdad());  
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            ProfesorControlador.modificarRegistro(id, nombre, correo, edad);
